		...
		cards: [
			{
				...
				cardAmount: 2,
				imagePath:
					'src/assets/img/Decks/King Arthur/front/claws_that_catch.png',
			},
			{
				name: 'Drink Me',
				effectTiming: CardEffectTimingEnum.NONE,
				...
				boostValue: 2,
				cardAmount: 2,
				imagePath: 'src/assets/img/Decks/King Arthur/front/drink_me.png',
			},
			{
				name: 'Eat Me',
				effectTiming: CardEffectTimingEnum.NONE,
				...
				boostValue: 3,
				cardAmount: 2,
				imagePath: 'src/assets/img/Decks/King Arthur/front/eat_me.png',
			},
			{
				...universalCards.feint,
				boostValue: 2,
			...
			},
			{
				...
				boostValue: 3,
				cardAmount: 3,
				imagePath: 'src/assets/img/Decks/King Arthur/front/im_late.png',
			},
			{
				name: 'Jaws that Bite',
				effectTiming: CardEffectTimingEnum.AFTER_COMBAT,
				...
				boostValue: 2,
				cardAmount: 2,
				imagePath: 'src/assets/img/Decks/King Arthur/front/jaws_that_bite.png',
			},
			{
				...universalCards.regroup,
				boostValue: 2,
			...
			},
			{
				...
				boostValue: 4,
				cardAmount: 2,
				imagePath: 'src/assets/img/Decks/King Arthur/front/looking_glass.png',
			},
			{
				name: 'Mad as a Hatter',
				effectTiming: CardEffectTimingEnum.AFTER_COMBAT,
				...
				boostValue: 1,
				cardAmount: 2,
				imagePath: 'src/assets/img/Decks/King Arthur/front/mad_as_a_hatter.png',
			},
			{
				name: 'Manxome Foe',
				effectTiming: CardEffectTimingEnum.DURING_COMBAT,
				...
				boostValue: 2,
				cardAmount: 2,
				imagePath: 'src/assets/img/Decks/King Arthur/front/manxome_foe.png',
			},
			{
				...universalCards.momentousShift,
				cardAmount: 2,
			...
			},
			{
				...
				boostValue: 4,
				cardAmount: 1,
				imagePath: 'src/assets/img/Decks/King Arthur/front/o_frabjous_day.png',
			},
			{
				name: 'The Other Side of the Mushroom',
				effectTiming: CardEffectTimingEnum.AFTER_COMBAT,
				...
				cardAmount: 1,
				imagePath:
					'src/assets/img/Decks/King Arthur/front/other_side_of_the_mushroom.png',
			},
			{
				...universalCards.skirmish,
				cardAmount: 2,
			...
			},
			{
				...
				boostValue: 4,
				cardAmount: 1,
				imagePath: 'src/assets/img/Decks/King Arthur/front/snicker-snack.png',
			},
		],
	},
}
